...
export const fetchChaptersContent = async (
  projectId: string
...
export const fetchRelatedSubgraph = async (
  projectId: string,
  anchors: string[],
  ...
  const response = await fetch(
    `${API_BASE}/graph/${projectId}/subgraph?anchors=${encodeURIComponent(anchors.join(','))}&branchId=${branchId}`
  );
...
export const fetchNarrativeInsights = async (
  projectId: string,
  branchId: string = 'main'
): Promise<any[]> => {
...
export const fetchPhysicalStatus = async (
  ...
  const response = await fetch(
    `${API_BASE}/graph/${projectId}/physical-status?names=${encodeURIComponent(characterNames.join(','))}&branchId=${branchId}`
  );
 ...
 */
export const fetchUnresolvedForeshadowing = async (
  projectId: string,
  branchId: string = 'main'
...
export const simulatePropagation = async (
  projectId: string,
  triggerName: string,
...
> => {
  const response = await fetch(
    `${API_BASE}/graph/${projectId}/characters/${characterId}/evolution`
  );
...
> => {
  const response = await fetch(
    `${API_BASE}/graph/${projectId}/characters/${characterId}/foreshadowing`
  );
...
export const fetchChapterCharacterNetwork = async (
  ...
  const response = await fetch(
    `${API_BASE}/graph/${projectId}/chapters/${chapterId}/character-network`
  );
