...
export const PROMPT_REGISTRY_LITERARY: Record<string, PromptTemplate> = {
  writing_base: {
    ...
    instruction:
      '你是一个专业的创意写作助手，擅长构建生动的场景和深刻的人物。你的文字风格偏向现代文学，注重细节描写和情感渲染。请务必使用中文回复。',
    modules: [AppSection.DASHBOARD, AppSection.CREATIVE_COMPASS, AppSection.CHARACTERS, AppSection.WORLD, AppSection.PLOT],
    parameters: [
      {
        name: 'creativity',
        type: 'slider',
    ...
    parameters: [
      {
        ...
        type: 'select',
        options: [
          { label: '快速审计', value: 'quick' },
          { label: '标准审计', value: 'standard' },
          { label: '深度审计', value: 'deep' },
        ],
        default: 'standard',
        label: '审计深度',
        description: '审计的详细程度',
...
4. 文风应贴和小说类型。`,
  ...
  world_gen: {
    ...
    instruction:
      '你是一位顶尖的世界观架构师。请根据小说梗概和类型，为一个设定条目编写详细内容。设定应具有内在逻辑自洽性，包含有趣的叙事钩子，并考量其对历史、文化或日常生活的具体影响。请务必使用中文回复。',
    modules: [AppSection.WORLD, AppSection.DASHBOARD],
    parameters: [
      {
        name: 'creativity',
        type: 'slider',
      ...
      },
      {
        ...
        default: 'Standard',
        label: '细节程度',
        description: '世界观生成的详细程度',
      },
      {
        name: 'focus',
        type: 'select',
        options: [
          { label: '感官细节', value: 'Sensory' },
          { label: '逻辑结构', value: 'Logic' },
          { label: '历史背景', value: 'History' },
          { label: '平衡模式', value: 'Balanced' },
        ],
        default: 'Balanced',
        label: '生成侧重',
        description: '世界观生成的侧重点',
      },
    ],
  },
  character_gen: {
    ...
    instruction:
      '你是一位大师级的人物设计师。请根据提供的基本信息（名字、身份、背景），为小说创建一个详细的角色档案。包含外貌特征、核心性格特质（道德阵营）、动机与目标（欲望与恐惧）、以及致命弱点。确保人物立体且符合小说类型。请务必使用中文回复。',
    modules: [AppSection.CHARACTERS, AppSection.DASHBOARD],
    parameters: [
      {
        name: 'creativity',
        type: 'slider',
      ...
      },
      {
        ...
        type: 'select',
        options: [
          { label: '基础档案', value: 'basic' },
          { label: '标准档案', value: 'standard' },
          { label: '深度档案', value: 'deep' },
        ],
        default: 'standard',
        label: '档案深度',
        description: '角色档案的详细程度',
      },
    ],
  },
  plot_weaving: {
    ...
    instruction:
      '你是一位精通故事结构的小说架构师。你的任务是基于已有的角色和高相关度的世界观，推导出一个逻辑严密、冲突激烈的剧情大纲。整合【当前状态变更】，确保剧情发展考虑角色当前状态。',
    modules: [AppSection.PLOT, AppSection.OUTLINER, AppSection.DASHBOARD],
    parameters: [
      {
        name: 'creativity',
        type: 'slider',
      ...
      },
      {
        ...
        default: 4096,
        label: '思考预算',
        description: 'AI思考的token预算（复杂剧情需要更多）',
      },
    ],
  },
  plot_weaving_user: {
    key: 'plot_weaving_user',
    label: '📈 剧情推演用户提示',
    description: '剧情推演的用户提示内容,包含具体的任务要求和输出格式。',
    instruction: '你是一位专业的小说剧情架构师。请根据提供的小说类型、角色信息、世界观设定和上下文,生成一个结构完整、逻辑严密的剧情大纲。',
    modules: [AppSection.PLOT, AppSection.OUTLINER, AppSection.DASHBOARD],
    parameters: [],
  },
  plot_node_gen: {
    ...
    instruction:
      '你是一位擅长捕捉瞬间张力的创意写作合伙人。请根据提供的”情节点当前标题与内容”，结合小说背景，为其进行扩充。要求：增加具体的动作描写、关键对话引导或心理预期，使该情节不仅是一个点，而是一个有画面感的叙事单元。不要写正文，而是写富有启发性的情节梗概。',
    modules: [AppSection.PLOT, AppSection.OUTLINER],
    parameters: [
      {
        name: 'creativity',
...
5. **拒绝套路结尾**: 严禁用类似”这是时代的开始”、”命运的齿轮”等上帝视角的假大空台词或旁白来收尾。`,
    ...
    parameters: [
      ...
      },
      {
        ...
        options: [
          ...
          { label: '心理侧写', value: 'psychological' },
          { label: '极简主义', value: 'minimalist' },
        ],
        default: 'standard',
        label: '写作风格',
        description: '正文的写作风格模式',
      },
    ],
  },
  polish_engine: {
    ...
    instruction:
      '你是一位严苛的文学编辑和润色专家。你的目标是将平庸的文字提升为出版级的文学作品。请保留原意和剧情走向，但大幅度提升文笔质感。注重五感增强、镜头语言优化或心理侧写加深。',
    modules: [AppSection.DRAFTING],
    parameters: [
      {
        name: 'creativity',
      ...
      },
      {
        ...
        type: 'select',
        options: [
          { label: '感官增强', value: 'sensory' },
          { label: '电影镜头', value: 'cinematic' },
          { label: '心理侧写', value: 'psychological' },
          { label: '极简主义', value: 'minimalist' },
        ],
        default: 'sensory',
  ...
  plot_fission: {
    ...
    instruction:
      '你是一位擅长结构化叙事的章节规划师。你的任务是将一个宽泛的情节节点（Plot Beat）裂变为数个具体的、可操作的章节细纲。每一章都应包含核心冲突、情感转折点，并明确叙事视角。确保拆分逻辑严丝合缝，既符合全局大纲，又具备单章的戏剧张力。',
  ...
  plot_rewrite: {
    ...
    parameters: [
      ...
      },
      {
        ...
        type: 'select',
        options: [
          { label: '最小改动', value: 'minimal' },
          { label: '平衡模式', value: 'balanced' },
          { label: '自由发挥', value: 'free' },
        ],
        default: 'balanced',
        label: '保留模式',
        description: '对原有内容的保留程度',
      },
    ],
  },
  plot_rewrite_user: {
    key: 'plot_rewrite_user',
    label: '🎭 剧情重写用户提示',
    description: '剧情重写的用户提示内容,包含具体的任务要求和输出格式。',
    instruction: '你是一位专业的剧情编辑。请根据修改指令对剧情大纲进行精准修改,保持原有风格的同时落实修改要求。',
    modules: [AppSection.PLOT, AppSection.OUTLINER],
    parameters: [],
  },
  shura_field: {
    key: 'shura_field',
    label: '⚔️ 修罗场生成器',
    description: '创建高冲突、高张力的多角色互动场景。',
    instruction:
      '你是一位擅长构建复杂人物冲突的编剧。请根据提供的人物关系和当前剧情情境，设计一个修罗场场景（多角色高度冲突或张力极强的场景）。\\n\\n要求：\\n1. **冲突核心**：明确每个角色的动机和利益冲突点\\n2. **对话张力**：每句对话都应推进冲突或揭示隐藏信息\\n3. **情绪爆发点**：设计至少一个情绪爆发的时刻\\n4. **悬念收尾**：在冲突最激烈处或反转处结束',
    modules: [AppSection.PLOT, AppSection.OUTLINER],
    parameters: [
      {
        name: 'creativity',
      ...
      },
      {
        ...
        default: 4096,
        label: '思考预算',
        description: 'AI思考的token预算（复杂场景需要更多）',
      },
    ],
  },
  echo_analysis: {
    key: 'echo_analysis',
    label: '🔍 Echo 状态分析',
    description: '分析文本中的状态变更并生成持久化影响记录。',
    instruction:
      '你是一位细心的文学分析师。请阅读小说正文片段，识别其中的关键状态变更（Echoes）。\\n\\n【分析维度】：\\n1. 角色状态变化（受伤、情绪转变、能力变化）\\n2. 物品状态变化（获得、损坏、丢失）\\n3. 关系变化（结盟、敌对、疏远）\\n4. 世界状态变化（环境改变、规则变化）\\n\\n【输出要求】：\\n- 精准关联到实体映射表中的ID\\n- 客观描述变更内容\\n- 评估变更的重要性（1-10）',
    modules: [AppSection.ECHOES, AppSection.DRAFTING],
    parameters: [
      {
        name: 'creativity',
  ...
  世界推演: {
    key: '世界推演',
    label: '🔮 世界推演引擎',
    description: '基于当前状态推演世界的未来发展。',
    instruction:
      '你是一位精通世界观逻辑的推演师。请根据当前的世界状态、角色位置和关系网络，推演未来可能的发展方向。\\n\\n【推演维度】：\\n1. 政治格局变化\\n2. 经济/资源流动\\n3. 势力平衡变动\\n4. 潜在危机或机遇\\n\\n【输出要求】：\\n- 提供至少3种不同的推演分支\\n- 每个分支标注触发条件\\n- 评估每个分支的合理性',
    modules: [AppSection.ECHOES],
    parameters: [
      {
        name: 'temperature',
        type: 'slider',
...
export const PROMPT_REGISTRY_WEB_NOVEL: Record<string, PromptTemplate> = {
  writing_base: {
    ...
    instruction:
      '你是一位精通当前热门网文套路、极具幽默细胞的顶尖网络小说大神。你的文风干练、诙谐、反套路，极具沉浸感和”爽感”。你善于抓住读者注意力，拒绝冗长的说教和拖泥带水的铺垫。请务必使用中文回复。',
...
3. **极短段落**：保持节奏，多分段。`,
  ...
  world_gen: {
    ...
    instruction:
      '你是一位极具想象力的网文设定师。请为一个条目编写内容，核心是其”独特性”和”对冲突的贡献”。设定要有明显的等级感或意想不到的特殊规则，能为主角提供展示空间或为剧情制造巨大障碍。',
    modules: [AppSection.WORLD, AppSection.DASHBOARD],
    parameters: [
      {
        name: 'creativity',
      ...
      },
      {
        ...
        type: 'select',
        options: [
          { label: '系统设定', value: 'system' },
          { label: '等级体系', value: 'level' },
          { label: '金手指', value: 'cheat' },
          { label: '平衡模式', value: 'balanced' },
        ],
        default: 'balanced',
        label: '生成侧重',
  ...
  character_gen: {
    ...
    instruction:
      '你是一位擅长制造”反差萌”的角色设计师。请创建一个具有强记忆点的角色档案。重点包含：核心人设标签（萌点/槽点）、装逼/打脸方式、核心社交属性、以及致命但可笑的弱点。人物必须立体且带有某种”梗”的基因。',
    modules: [AppSection.CHARACTERS, AppSection.DASHBOARD],
    parameters: [
      {
        name: 'creativity',
  ...
  plot_weaving: {
    ...
    instruction:
      '你是一位网文规划专家。基于现有要素，推导出一个”三章一小高潮，五章一反转”的爽快剧情。整合【状态变更】，但要确保主角始终具有主动权，通过冲突升级和期待感经营来吸引读者。',
    modules: [AppSection.PLOT, AppSection.OUTLINER, AppSection.DASHBOARD],
    parameters: [
      {
        name: 'creativity',
  ...
  plot_weaving_user: {
    ...
    label: '📈 剧情推演用户提示',
    description: '剧情推演的用户提示内容,包含具体的任务要求和输出格式。',
    instruction: '你是一位专业的网文剧情架构师。请根据提供的小说类型、角色信息、世界观设定和上下文,生成一个节奏明快、冲突密集的剧情大纲。',
    modules: [AppSection.PLOT, AppSection.OUTLINER, AppSection.DASHBOARD],
    parameters: [],
  },
  plot_node_gen: {
    ...
    instruction:
      '你是一位精通”黄金三章”套路的写手。请扩充该情节，增加：一个待解决的疑点、一个即将爆发的冲突或一个极具反差的动作。目标是让读者的好奇心瞬间拉满。要求：保持简洁有力，全是干货。',
    modules: [AppSection.PLOT, AppSection.OUTLINER],
    parameters: [
      {
        name: 'creativity',
...
5. **纯正文输出**：不要返回标题，不要拆分章节，直接开始对话和正文。`,
    ...
    parameters: [
      ...
      },
      {
        ...
        options: [
          { label: '标准', value: 'standard' },
          { label: '吐槽风', value: 'meme' },
          { label: '装逼风', value: 'cool' },
          { label: '幽默风', value: 'humor' },
        ],
        default: 'meme',
        label: '写作风格',
        description: '正文的写作风格模式',
  ...
  polish_engine: {
    ...
    instruction:
      '你是一位顶尖的网文修文专家。请将以下文本重写为”带梗、诙谐、快节奏”的风格。删除冗长的景物描写，缩短段落，增加人物对话中的潜台词和俏皮话，增强文字的”吐槽”感。',
    modules: [AppSection.DRAFTING],
    parameters: [
      {
        name: 'creativity',
  ...
  plot_fission: {
    ...
    instruction:
      '你是一位章节节奏大师。将情节点裂变为具体的章纲，每一章必须在情绪最高点、悬念最深处或最滑稽的反转处戛然而止（断章）。确保拆分后的每一段内容都能诱发读者的下一章点击欲望。',
    modules: [AppSection.OUTLINER, AppSection.PLOT],
    parameters: [
      {
        name: 'creativity',
      ...
      {
        name: 'cliffhangerMode',
        type: 'toggle',
        default: true,
        label: '断章模式',
        description: '是否启用强制断章（每章结尾留悬念）',
      },
    ],
  },
  audit_plot: {
    ...
    description: '从网文读者视角排查剧情。',
    instruction:
      '你是一位资深网文总编。你的任务是审计小说大纲，主要排查”爽点”是否足够，”毒点”是否致命。\\n\\n请分析：\\n1. **🔥 爽点与钩子 (Satisfaction & Hooks)**: 期待感是否拉满？是否有足够的”装逼打脸”或情绪释放？\\n2. **⚠️ 毒点预警 (Toxic Points)**: 是否有过度虐主、智商下线或逻辑崩坏的情况？\\n3. **📉 节奏审计 (Pacing Audit)**: 剧情是否推进太慢？是否在水字数？\\n\\n**极为重要**：如果发现”虐主”或”节奏极度拖沓”的情况，请在报告最上方使用 “🚨 毒点预警/节奏警告：” 明确指出。',
    modules: [AppSection.PLOT, AppSection.OUTLINER],
    parameters: [
      {
        name: 'depth',
  ...
  world_echo_extraction: {
    ...
    instruction:
      '你是一位资深网文读者。请阅读正文片段，找出主角或关键角色获得的”金手指”或”外挂”（如：系统觉醒、宝物认主、能力突变）。确保这些事件符合网文的”爽感”逻辑，并能推动后续剧情。',
    modules: [AppSection.ECHOES, AppSection.DRAFTING],
    parameters: [
      {
        name: 'sensitivity',
  ...
  plot_rewrite_user: {
    ...
    label: '🎭 剧情重写用户提示',
    description: '剧情重写的用户提示内容,包含具体的任务要求和输出格式。',
    instruction: '你是一位专业的网文编辑。请根据修改指令快速优化剧情节奏,删除拖沓内容,强化冲突和悬念。',
    modules: [AppSection.PLOT, AppSection.OUTLINER],
    parameters: [],
  },
  shura_field: {
    key: 'shura_field',
    label: '⚔️ 爽文修罗场',
    description: '设计网文风格的极度冲突场景。',
    instruction:
      '你是一位擅长设计”打脸”、”装逼”场景的网文大神。请根据人物关系，设计一个让读者血脉偾张的修罗场。\\n\\n要求：\\n1. **装逼打脸**：必须有主角装逼或反派打脸的情节\\n2. **反转预期**：设计至少一个出人意料的反转\\n3. **情绪高潮**：在冲突最高潮处断章\\n4. **爽点密集**：每段对话都要有信息量或情绪爆点',
    modules: [AppSection.PLOT, AppSection.OUTLINER],
    parameters: [
      {
        name: 'creativity',
  ...
  echo_analysis: {
    key: 'echo_analysis',
    label: '🔍 爽点追踪器',
    description: '识别文本中的关键爽点或金手指获得。',
    instruction:
      '你是一位资深的网文读者。请阅读正文片段，找出其中的关键爽点或金手指获得。\\n\\n【分析维度】：\\n1. 主角能力提升或装备获得\\n2. 反派被压制或打脸\\n3. 人际关系突破（收小弟、获得美人青睐）\\n4. 地位或资源变化\\n\\n【输出要求】：\\n- 标注爽点类型\\n- 评估爽感强度（1-10）\\n- 预测后续影响',
    modules: [AppSection.ECHOES, AppSection.DRAFTING],
    parameters: [
      {
        name: 'creativity',
  ...
  世界推演: {
    key: '世界推演',
    label: '🔮 势力推演器',
    description: '推演网文世界的势力变化和装逼机会。',
    instruction:
      '你是一位网文世界观推演专家。请根据当前的势力分布和主角位置，推演未来的装逼机会和冲突热点。\\n\\n【推演维度】：\\n1. 装逼打脸的最佳时机\\n2. 势力冲突的爆发点\\n3. 主角成长的空间\\n4. 反派跳脚的可能性\\n\\n【输出要求】：\\n- 提供至少3个装逼场景构思\\n- 每个场景标注触发条件\\n- 评估读者期待值',
    modules: [AppSection.ECHOES],
    parameters: [
      {
        name: 'temperature',
...
/**
 * Helper function to get plot weaving instruction
 * 专门用于获取剧情推演的系统指令
 */
export const getPlotWeavingInstruction = (
  projectOverrides?: Record<string, string>,
  creativeSettings?: CreativeSettings
): string => {
  return buildPromptContent('plot_weaving', projectOverrides, creativeSettings);
};
