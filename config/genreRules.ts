...
export const GENRE_RULES: Record<string, GenreRule> = {
  xuanhuan: {
    ...
    narrativeGuidance: '以战斗和资源获取驱动剧情。主角行为由利益驱动，杀伐果断。三章内应有明确反馈。核心对手必须有脑子。',
  ...
  xianxia: {
    id: 'xianxia',
    name: '仙侠',
    fatigueWords: ['冷笑', '蝼蚁', '倒吸凉气', '瞳孔骤缩', '不可置信', '满场死寂', '难以置信', '竟然'],
    ...
    narrativeGuidance: '以修行为主线，夹杂红尘历练。注重境界突破的仪式感和因果报应。人际关系以师徒、道侣、同道为核心。',
  ...
  dushi: {
    id: 'dushi',
    name: '都市',
    fatigueWords: ['冷笑', '蝼蚁', '倒吸凉气', '瞳孔骤缩', '不可置信', '满场死寂', '竟然', '不由得'],
    ...
    narrativeGuidance: '贴近现实生活，节奏明快。以情感线和事业线双线并行。冲突来源是人际关系和利益纠葛。',
  ...
  kongbu: {
    ...
    narrativeGuidance: '以悬疑和恐惧感为核心。通过未知和不确定制造压迫感。角色在极端环境下的真实反应比怪物本身更重要。',
...
export function getPostWriteOptionsFromGenre(genre: string): { fatigueWords: string[]; prohibitions: string[] } {
