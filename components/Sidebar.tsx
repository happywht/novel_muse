...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <aside
      className={`fixed left-0 top-0 bottom-0 z-50 flex flex-col bg-slate-950 border-r border-slate-800/80 transition-all duration-300 ease-in-out ${
            ...
            >
              <div
                className={`relative shrink-0 p-1.5 rounded-lg transition-colors ${
                  isActive ? item.bgColor : 'group-hover:bg-slate-800'
                }`}
              >
                <Icon size={18} />
                {/* Echo dot */}
