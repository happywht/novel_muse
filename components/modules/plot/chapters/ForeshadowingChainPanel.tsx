                    ...
                    {loading ? (
                        ...
                        <div className="space-y-3">
                            ...
                            {foreshadowing.map((item, idx) => (
                                ...
                                >
                                    <button
                                        onClick={() => setExpandedId(expandedId === `${item.subject}-${item.object}-${idx}` ? null : `${item.subject}-${item.object}-${idx}`)}
                                    ...
                                    >
                                        ...
                                        <div className="flex items-center gap-2">
                                            <span className={`text-xs px-2 py-0.5 rounded-full ${
                                                item.relatedChapter ? 'bg-emerald-500/20 text-emerald-400' : 'bg-amber-500/20 text-amber-400'
                                            }`}>
