    ...
    <div className="p-6 space-y-8 overflow-y-auto custom-scrollbar">
      ...
      <div>
        ...
        >
          ...
          <span className="text-sm font-medium text-muse-400 group-hover:text-muse-300">
            查看完整使用说明书
          </span>
    ...
    <div className="space-y-6">
      <div className="space-y-4">
        <p className="text-slate-300 leading-relaxed">
          欢迎使用 <strong className="text-muse-400">Muse 小说架构师</strong>
          。这是一个旨在帮助小说作者突破创作瓶颈、完善世界观设定的 AI
          辅助工具。以下是各模块的详细功能介绍：
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-slate-800/50 p-5 rounded-xl border border-slate-700/50">
          ...
          <ul className="list-disc list-inside text-sm text-slate-300 space-y-1">
            ...
            <li>
              <strong className="text-white">AI 灵感火花</strong>：输入一个模糊的想法，AI
              会为你生成完整的书名建议、核心冲突和电梯游说词。
            </li>
          </ul>
        </div>
        ...
        <div className="bg-slate-800/50 p-5 rounded-xl border border-slate-700/50">
          ...
          <ul className="list-disc list-inside text-sm text-slate-300 space-y-1">
            ...
            <li>
              <strong className="text-white">立绘生成</strong>：点击相机图标，AI
              将根据角色描述绘制高清人物概念图。
            </li>
          </ul>
        </div>
