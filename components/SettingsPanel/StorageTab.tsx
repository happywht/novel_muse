            ...
            <div>
                ...
                <div>
                    ...
                    <input
                        ...
                        onChange={(e) => setLocalConfig({ ...localConfig, autoSaveInterval: parseInt(e.target.value) })}
                        disabled={!editing}
            ...
            <div>
                ...
                <div className="space-y-4">
                    <div>
                        <label className="flex items-center gap-3 cursor-pointer">
                            <input
                                ...
                                onChange={(e) => setLocalConfig({ ...localConfig, backendSyncEnabled: e.target.checked })}
                                disabled={!editing}
                    ...
                    {localConfig.backendSyncEnabled && (
                        <div>
                            <label className="block text-xs font-medium text-slate-400 mb-2">同步间隔 (毫秒)</label>
                            <input
                                type="number"
                                min="5000"
                                max="120000"
                                ...
                                onChange={(e) => setLocalConfig({ ...localConfig, backendSyncInterval: parseInt(e.target.value) })}
                                disabled={!editing}
                                className="w-full bg-slate-950 border border-slate-700 rounded-lg px-4 py-2.5 text-sm text-white
                                    focus:border-muse-500 outline-none disabled:bg-slate-800/50 disabled:text-slate-500"
                            />
