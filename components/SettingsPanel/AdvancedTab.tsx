        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setLocalConfig({ ...localConfig, virtualScrollThreshold: parseInt(e.target.value) })
              }
              disabled={!editing}
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setLocalConfig({ ...localConfig, inputDebounce: parseInt(e.target.value) })
              }
              disabled={!editing}
              className="w-full bg-slate-950 border border-slate-700 rounded-lg px-4 py-2.5 text-sm text-white
                                focus:border-muse-500 outline-none disabled:bg-slate-800/50 disabled:text-slate-500"
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setLocalConfig({ ...localConfig, searchDebounce: parseInt(e.target.value) })
              }
              disabled={!editing}
              className="w-full bg-slate-950 border border-slate-700 rounded-lg px-4 py-2.5 text-sm text-white
                                focus:border-muse-500 outline-none disabled:bg-slate-800/50 disabled:text-slate-500"
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setLocalConfig({ ...localConfig, syncDebounce: parseInt(e.target.value) })
              }
              disabled={!editing}
              className="w-full bg-slate-950 border border-slate-700 rounded-lg px-4 py-2.5 text-sm text-white
                                focus:border-muse-500 outline-none disabled:bg-slate-800/50 disabled:text-slate-500"
        ...
        <div className="space-y-3">
          <label className="flex items-center gap-3 cursor-pointer p-2 hover:bg-slate-800/30 rounded transition-colors">
            <input
              ...
              onChange={(e) =>
                setLocalConfig({ ...localConfig, enableEchoSystem: e.target.checked })
              }
              disabled={!editing}
              className="w-4 h-4 text-muse-500 rounded"
            />
          ...
          <label className="flex items-center gap-3 cursor-pointer p-2 hover:bg-slate-800/30 rounded transition-colors">
            <input
              ...
              onChange={(e) =>
                setLocalConfig({ ...localConfig, enableKnowledgeGraph: e.target.checked })
              }
              disabled={!editing}
              className="w-4 h-4 text-muse-500 rounded"
            />
          ...
          <label className="flex items-center gap-3 cursor-pointer p-2 hover:bg-slate-800/30 rounded transition-colors">
            <input
              ...
              onChange={(e) =>
                setLocalConfig({ ...localConfig, enableChapterBalance: e.target.checked })
              }
              disabled={!editing}
              className="w-4 h-4 text-muse-500 rounded"
            />
          ...
          <label className="flex items-center gap-3 cursor-pointer p-2 hover:bg-slate-800/30 rounded transition-colors">
            <input
              ...
              onChange={(e) =>
                setLocalConfig({ ...localConfig, enableConflictVisualization: e.target.checked })
              }
              disabled={!editing}
              className="w-4 h-4 text-muse-500 rounded"
            />
          ...
          <label className="flex items-center gap-3 cursor-pointer p-2 hover:bg-slate-800/30 rounded transition-colors">
            <input
              ...
              onChange={(e) =>
                setLocalConfig({ ...localConfig, enableVirtualScrolling: e.target.checked })
              }
              disabled={!editing}
              className="w-4 h-4 text-muse-500 rounded"
            />
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                setLocalConfig({
                  ...localConfig,
                  logLevel: e.target.value as 'none' | 'error' | 'warn' | 'info' | 'debug',
                })
              }
              disabled={!editing}
              className="w-full bg-slate-950 border border-slate-700 rounded-lg px-4 py-2.5 text-sm text-white
