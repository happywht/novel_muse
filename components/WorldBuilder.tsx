...
import { Globe, Plus, Trash2, Map, Shield, Users, Scroll, BookPlus, AlertCircle, CheckCircle, Settings2, Eye, Cpu, BookOpen, GitCommit, Check } from 'lucide-react';
    ...
    <div className="flex h-[calc(100vh-140px)] gap-6 relative">
       ...
       <div className="w-1/3 flex flex-col bg-slate-800/50 border border-slate-700 rounded-xl overflow-hidden relative">
          <div className="p-4 border-b border-slate-700 bg-slate-900/50 flex flex-col gap-3">
             ...
             <div className="text-xs text-muse-300 font-medium text-center">
          ...
          <div className="flex-1 overflow-y-auto p-2 space-y-2">
             <div className="p-2">
                <div className="flex gap-2">
                    <input 
                        ...
                        placeholder={`新的${CATEGORIES.find(c => c.id === selectedCategory)?.label}词条...`}
             ...
             {project.worldSettings.filter(w => w.category === selectedCategory).map(lore => {
             ...
             {project.worldSettings.filter(w => w.category === selectedCategory).length === 0 && (
