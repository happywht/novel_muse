...
import { Users, GitBranch, AlertTriangle, ArrowRight, Loader2 } from 'lucide-react';
      ...
      <div className="bg-slate-800/50 rounded-lg p-4 border border-slate-700">
        ...
        <div className="flex gap-2 mb-3">
          <select
            ...
            onChange={(e) => onChar1Change(e.target.value || null)}
          ...
          <select
            ...
            onChange={(e) => onChar2Change(e.target.value || null)}
            className="flex-1 bg-slate-900 border border-slate-700 rounded px-2 py-1.5 text-xs text-slate-300"
          >
                  ...
                  <div className="flex-1 h-1 bg-slate-800 rounded-full overflow-hidden">
                    <div
                      className={`h-full rounded-full ${
                        item.weight > RELATIONSHIP_CONFIG.HIGH_WEIGHT_THRESHOLD
                          ? 'bg-rose-500'
                          : item.weight > RELATIONSHIP_CONFIG.MEDIUM_WEIGHT_THRESHOLD
                            ? 'bg-amber-500'
                            : 'bg-blue-500'
                      }`}
