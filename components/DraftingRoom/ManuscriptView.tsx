...
export const ManuscriptView: React.FC<ManuscriptViewProps> = ({
    ...
    const saveScrollPosition = () => {
      if (leftScrollRef.current) {
        sessionStorage.setItem(
          'manuscript-left-scroll',
          leftScrollRef.current.scrollTop.toString()
        );
      }
    };
  ...
  return (
    <div
      className="w-full flex gap-6 pt-10 overflow-hidden"
                ...
                <div className="p-6 border-b border-slate-800 bg-slate-950/30 flex justify-between items-end shrink-0">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-slate-500 mt-2">
                      字数统计: {hasContent ? chapter.content.length : 0} 字 · 最后修改:{' '}
