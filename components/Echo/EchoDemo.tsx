  ...
  return (
    <div className="min-h-screen bg-slate-950 p-8">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-2xl font-bold text-white mb-6">Echo渐进式确认UI演示</h1>
          ...
          <div className="col-span-2">
            <div className="bg-slate-900 rounded-xl border border-slate-800 overflow-hidden">
              <div className="p-4 border-b border-slate-800 bg-slate-950/50">
                <h2 className="text-lg font-bold text-white">DraftingRoom集成示例</h2>
              </div>
        ...
        <div className="mt-6 bg-slate-900 rounded-xl border border-slate-800 p-4">
          ...
          <div className="grid grid-cols-4 gap-4 text-xs">
            ...
            <div className="bg-amber-900/20 border border-amber-500/50 rounded-lg p-3">
              ...
              <div className="text-2xl font-bold text-white">
                {
                  echoes.filter((e) => (e.confidence || 0.7) >= 0.5 && (e.confidence || 0.7) < 0.85)
                    .length
                }
              </div>
