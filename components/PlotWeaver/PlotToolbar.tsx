...
import { GitBranch, Activity, TrendingUp, Lightbulb, Info, Save, History, Sparkles } from 'lucide-react';
    ...
    <div className="flex items-center justify-between mb-6">
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          title="断点存档"
        >
          <Save size={16} /> <span className="hidden lg:inline">存版本</span>
        </button>
        <button
        ...
        <TemplateSelector onSelect={onGeneratePlot} isGenerating={isGeneratingPlot} />
      </div>
    </div>
  );
};
