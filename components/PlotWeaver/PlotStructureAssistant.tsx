...
const STRUCTURE_PROMPTS = [
  {
    label: '💡 头脑风暴：下一个关键事件',
    prompt:
      '请基于当前大纲的走向，头脑风暴3个可能的「下一步关键事件」，每个用简短的标题+简介形式呈现。不要写正文，只需要结构性建议。',
    icon: Sparkles,
  },
  {
    label: '🔀 设计剧情反转',
    prompt:
      '请为当前大纲设计2-3个出人意料的「剧情反转点」，说明反转的位置、核心内容和对整体叙事的影响。只提供结构性建议，不要写正文。',
    icon: Shuffle,
  },
  {
    label: '📐 章节结构拆分',
    prompt:
      '请将当前大纲拆分为具体的章节划分建议。列出每个章节的标题、核心事件、预期篇幅和节奏标注（如：紧张/舒缓/高潮/过渡）。',
    icon: ArrowRight,
  },
  {
    label: '🧩 补全遗漏线索',
    prompt:
      '请审查当前大纲，指出可能遗漏的伏笔回收、人物弧光断点、或世界观设定中未在剧情中体现的元素，并提供补充建议。',
    icon: ChevronRight,
  },
];
