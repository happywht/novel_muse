...
export const ARC_TEMPLATES: CharacterArcTemplate[] = [
    {
        type: 'redemption',
        name: '救赎弧线',
        description: '有缺陷的角色经历艰难困苦，最终获得救赎，从黑暗走向光明。经典如《绝命毒师》沃尔特·怀特、《星球大战》达斯·维达。',
    ...
    },
    {
        type: 'corruption',
        name: '堕落弧线',
        description: '正直的角色因野心、恐惧或外部压力而逐渐堕落，从光明走向黑暗。经典如《绝命毒师》沃尔特·怀特、《星球大战》安纳金。',
        phases: ['setup', 'rising-action', 'crisis', 'climax', 'resolution'],
        keyQuestions: [
            '角色最初的道德底线是什么？',
            '什么诱惑/威胁触发了堕落？',
    ...
    },
    {
        type: 'awakening',
        name: '觉醒弧线',
        description: '角色从无知/偏见/错误认知中觉醒，获得新的理解和力量。经典如《黑客帝国》尼奥、《冰雪奇缘》艾莎。',
        phases: ['setup', 'rising-action', 'crisis', 'climax', 'resolution'],
        keyQuestions: [
            '角色最初的错误认知/无知是什么？',
            '什么事件触发了觉醒？',
